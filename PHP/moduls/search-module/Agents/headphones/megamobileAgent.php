    ...
    namespace Agent{
        ...
        class Search implements Isearch{
            ...
            function __construct($argv){
                ...
                $url = "https://www.megamobile.co.il/search?q=".$this->product;
                $response = file_get_contents($url);

                // find link
                $_title = 'href="https://www.megamobile.co.il/p/';
                ...
                $this->link = "https://www.megamobile.co.il/p/".$this->link;

                // find price
                $_anchor = '<span>₪</span><span>';
           ...
           public function SendInfoToModule (){
            ...
            if($this->price != 0){
                $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,29,'$this->link')");
