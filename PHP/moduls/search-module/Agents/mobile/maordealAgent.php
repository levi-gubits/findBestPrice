    ...
    namespace Agent{
        ...
        class Search implements Isearch{
           ...
           function __construct($argv){
                ...
                $url = "https://www.maordeal.co.il/?s=".$this->product."&post_type=product&orderby=popularity";
                $response = file_get_contents($url);

                // find link
                $_title = ' <h3 class="product_title"><a href="https://www.maordeal.co.il/product/';
                ...
                $this->link = "https://www.maordeal.co.il/product/".$this->link;

                // find price
                $_anchor = '><span class="woocommerce-Price-amount amount"><bdi>';
