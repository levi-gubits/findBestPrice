    ...
    namespace Agent{
        ...
        class Search implements Isearch{
            ...
            function __construct($argv){
                ...
                $url = "https://video.org.il/search/?q=".$this->product;
                ...
                $this->link = "https://video.org.il/items/".$this->link;
           ...
           public function SendInfoToModule (){
            ...
            if($this->price != 0){
                if($this->link != 'https://video.org.il/items/he'){
                    $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,49,'$this->link')");
