    ...
    namespace Agent{
        ...
        class Search implements Isearch{
            ...
            function __construct($argv){
                ...
                $url = "https://www.watchcenter.co.il/search/?q=".$this->product;
                ...
                $this->link = "https://www.watchcenter.co.il/items/".$this->link;
           ...
           public function SendInfoToModule (){
            ...
            if($this->price != 0){
                $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,50,'$this->link')");
