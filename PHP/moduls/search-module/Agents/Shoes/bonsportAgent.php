    ...
    namespace Agent{
        ...
        class Search implements Isearch{
           ...
           function __construct($argv){
                ...
                $url = "https://www.bonsport.co.il/productslist.aspx?wsearch=".$this->product;
                $response = file_get_contents($url);

                // find link
                $_title = 'class="prodcubepname" href="';
                ...
                $this->link = "https://www.bonsport.co.il/".$this->link;

                // find price
                $_anchor = 'class="productcubeprice">';
           ...
           public function SendInfoToModule (){
            ...
            if($this->price != 0){
                ...
                echo "\nprice: ".$this->price."\n";
                echo "\nlink: ".$this->link."\n";
                $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,13,'$this->link')");
            }else{
