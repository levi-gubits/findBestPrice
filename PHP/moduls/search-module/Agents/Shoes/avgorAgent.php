    ...
    namespace Agent{
        ...
        class Search implements Isearch{
           ...
           function __construct($argv){
                ...
                $url = "https://www.avgor.co.il/search/?q=".$this->product;
                ...
                $this->link = "https://www.avgor.co.il/items/".$this->link;
           ...
           public function SendInfoToModule (){
            ...
            if($this->price != 0){
                ...
                echo "\nprice: ".$this->price."\n";
                echo "\nlink: ".$this->link."\n";
                $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,9,'$this->link')");
            }else{
