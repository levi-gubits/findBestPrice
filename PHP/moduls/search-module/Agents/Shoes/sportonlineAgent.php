    ...
    namespace Agent{
        ...
        class Search implements Isearch{
            ...
            function __construct($argv){
                ...
                $url = "https://www.sportonline.co.il/search/?q=".$this->product;
                ...
                $this->link = "https://www.sportonline.co.il/items/".$this->link;
                ...
                $this->price_number = (int)$this->price;
           ...
           public function SendInfoToModule (){
            ...
            if($this->price != 0){
                $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,43,'$this->link')");
