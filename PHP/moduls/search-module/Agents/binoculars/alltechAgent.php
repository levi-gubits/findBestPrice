    ...
    namespace Agent{
        ...
        class Search implements Isearch{
           ...
           function __construct($argv){
                ...
                $url = "https://www.alltech.co.il/search?t=".$this->product;
                $response = file_get_contents($url);

                // find link
                $_title = '<a href="/products/';
                ...
                $this->link = "https://www.alltech.co.il/products/".$this->link;

                // find price
                $_anchor = '<div class="product__price">';
           ...
           public function SendInfoToModule (){
            ...
            echo "\nlink: ".$this->link."\n";
                ...
                if($this->price != 0){
                    $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,6,'$this->link')");
                }else{
