    ...
    namespace Agent{
        ...
        class Search implements Isearch{
            ...
            function __construct($argv){
                ...
                $url = "https://regaimshop.co.il/catalog.asp?Action=Search&SW=".$this->product;
                $response = file_get_contents($url);

                // find link
                $_title = '<a href="Catalog.asp';
                ...
                $this->link = "https://regaimshop.co.il/Catalog.asp".$this->link;

                // find price
                $_anchor = '<span class="CAT_Values">';
           ...
           public function SendInfoToModule (){
            ...
            if($this->price != 0){
                $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,40,'$this->link')");
