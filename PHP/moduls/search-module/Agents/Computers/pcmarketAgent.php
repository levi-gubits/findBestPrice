    ...
    namespace Agent{
        ...
        class Search implements Isearch{
            ...
            function __construct($argv){
                ...
                $url = "https://www.pcmarket.co.il/?s=".$this->product."&post_type=product&type_aws=true";
                $response = file_get_contents($url);

                // find link
                $_title = '<h2><a href="https://www.pcmarket.co.il/product/';
                ...
                $this->link = "https://www.pcmarket.co.il/product/".$this->link;
           ...
           public function SendInfoToModule (){
            ...
            if($this->price != 0){
                $result = Database::command("INSERT INTO `products_stores`(`proid`, `price`, `stor_id`,`link`) VALUES ($this->proid,$this->price,37,'$this->link')");
